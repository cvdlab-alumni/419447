...
def half_circle (radius):
	dom2D = PROD([INTERVALS(PI)(60), INTERVALS(radius)(1)])
	def ball(p):
		a,r = p
		return [COS(a)*r, SIN(a)*r]
	return MAP(ball)(dom2D)
...
round_wall_east = T([2])([12.5])(R([1,2])(-PI/2)(DIFFERENCE([half_circle(12.5),half_circle(10)])))

round_wall_east_3D = PROD([round_wall_east, Q(h)])
...
round_wall_south = T([1,2])([6.25,6.25])(R([1,2])(PI)(DIFFERENCE([half_circle(6.25),half_circle(3.75)])))

round_wall_south_3D = PROD([round_wall_south, Q(h)])
...
wall = STRUCT([wall0, wall1_2_3_north,wall1_2_3_east,wall1_2_3_south, wall1_2_3_west])
